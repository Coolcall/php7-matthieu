    ...
    <main role="main">
        <div class="jumbotron">
            <div class="container">
                ...
                <p>
                    Exemple : <a href="/php7-matthieu/http/_get/_get.php?firstname=gabriel&lastname=pillet">/cours/16_http/03_get/index.php?firstname=gabriel&lastname=pillet</a>.
                </p>

                <p><a href="/php7-matthieu/http/_get/_get.php?firstname=Dark&lastname=Vador" class="btn btn-primary btn-lg" role="button">Dark Vador</a></p>
            </div>
        </div>
    </main>
